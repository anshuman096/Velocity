...
<SWITCH>"#"                   { this.popState(); this.begin("SL_COMMENT"); console.log("Single Line Comment"); return 'COMMENT_START' }
<SWITCH>"**"	              { this.popState(); this.begin("ML_COMMENT"); console.log("Multi-line Comment"); return 'COMMENT_START' }
...
"("                           return 'LPAR'
")"                           return 'RPAR'
{DIGIT}+                      { console.log("Got a number"); return 'NUMBER' }
...
/* Grammar production rules for Velocity include statements. Allows user to include multiple other files and/or variables in their Velocity program
...
/* Production rules for the proper syntax of adding variables, files, and both to the include command */
include_tokens
...
/* Grammar production rules for Velocity parse statements. Allows user to parse a single variable or file.
   This production rule only parses the '#parse(' statement within a command */
parse_statement
...
/* Production rules for the proper syntax of adding either a variable or filename to the parse command */
parse_tokens
    : var RPAR
    | string_stmt RPAR
    ;
...
if_part_stmts
    : HASH ELSEIF LPAR bool_statements RPAR
	{
...
foreach_statement
    : HASH FOREACH LPAR foreach_condition RPAR statements END
        {
...
/* Grammar production rules for Velocity maps, gives proper syntax for identifying a map within Velocity code via parentheses */
map_stmt
...
/* Grammar production rules for boolean statements in Velocity */
bool_stmt
    : LPAR bool_stmt RPAR
    | object AND object
        {
